...
screen grand_screen_2_jail():
    modal True
    frame:
        xsize 800
        ysize 400
        xalign 0.5 yalign 0.5
        text "Act 2 - The Questioning ":
            xalign 0.5
            
        textbutton "Click here to continue":
            xalign 0.5 ypos 150
            action Hide("grand_screen_2_jail")
...
style window:
    ...
    background Image("gui/GH_textbox.png", xalign=0.5, yalign=1.0)
